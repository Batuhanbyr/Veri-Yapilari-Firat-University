...
public class Main {
	...
	public static void main(String[] args) {
		...
		/* 4-) Tek yonlu 100 elemanlı listedeki 60. düğüm ile 80. düğüm arasındaki kısımmlar çıkarılıp 
		 *  dairesel liste haline getiriniz.
		 * NOT : bu işlemi min satır ile gerçekleştiriniz
		 * 
		 * 
		 * */
		
		TekYonlu teklist = new TekYonlu();
	    ...
	    /* 5-) Çift Yönlü Bağlı listeyi silen recursive methodu min kod ile yazınız.
	      (NOT : Kod max 3 satır olmalı)
	      
	           ----Koda çok basit olduğu için hemen aşşağıya yazdım ↓----
